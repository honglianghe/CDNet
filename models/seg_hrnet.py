...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.last_layer = nn.Sequential(
            ...
            nn.Conv2d(
                in_channels=last_inp_channels,
                out_channels=config.model['out_c'],
