...
class UpsampleBlock(nn.Module):
    ...
    def forward(self, x, skip_connection=1):  #
        ...
        if skip_connection is not None:
            # Padding in case the incomping volumes are of different sizes  #hhl20200413add
...
class Unet(nn.Module):
    ...
    def __init__(self,
        ...
        self.direction_conv = nn.Conv2d(64, 4+1, kernel_size=1)
        self.maskAtt = revAttention(4+1)
